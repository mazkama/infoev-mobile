...
class CalculatorController extends GetxController {
  ...
  void extractBatteryDetails(Map<String, dynamic> data) {
    try {
      ...
      if (batteryCategory != null) {
        ...
        if (capacitySpec != null && capacitySpec['vehicles'] != null && capacitySpec['vehicles'].isNotEmpty) {
        ...
        consumption = null; // Reset consumption so it will be calculated later from capacity/range
        ...
        if (rangeSpec != null && rangeSpec['vehicles'] != null && rangeSpec['vehicles'].isNotEmpty) {
      ...
      if (batteryCapacityValue == null || batteryCapacityValue == 0.0) {
        ...
        if (capacityHighlight != null && capacityHighlight['value'] != null) {
          batteryCapacityValue = double.tryParse(capacityHighlight['value'].toString());
          batteryCapacity.value = batteryCapacityValue ?? 0.0;
          print('Kapasitas Baterai (dari highlight): ${batteryCapacity.value} kWh');
        }
      }
      ...
      if ((consumption == null || consumption == 0.0) && 
          batteryCapacityValue != null && batteryCapacityValue! > 0 &&
  ...
  void calculateCosts() {
    ...
    print('Biaya pengisian penuh: Rp ${fullChargeCost.value.toStringAsFixed(2)}');
